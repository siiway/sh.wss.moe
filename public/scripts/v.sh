#!/usr/bin/env bash
set -euo pipefail
# Help: curl sh.wss.moe/v.help

echo "=== v.sh installer ==="
echo "Help: curl sh.wss.moe/v.help"
...
curl -fsSL https://gist.githubusercontent.com/wyf9/ff12240ae023da0a068f2466968e3681/raw/v.sh > "${install_path}"
